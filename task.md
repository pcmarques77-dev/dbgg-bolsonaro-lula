...
- [x] Adicionar estados de controles no React para o Multiplicador Fiscal ($\mu$) e Sensibilidade de Juros ($\gamma$).
- [x] Criar a alternância entre Primário Real e Primário Estrutural.
- [x] Implementar a lógica de recálculo recursivo dinâmico de PIB nominal ($g_t$) e Juros implícitos ($i_t$) com base nos desvios fiscais.
- [x] Calcular dinamicamente o Resultado Primário Estabilizador anual.

### 4. Interface Gráfica e Visualização
- [x] Adicionar sliders de controle de multiplicadores na tela com design premium dark.
- [x] Atualizar o gráfico da trajetória da dívida para ir até 2030 e plotar a linha do Primário Estabilizador.
- [x] Atualizar a tabela de detalhamento anual de cálculos e adicionar os Bento Cards de comentários metodológicos atualizados.
- [x] Validar a compilação local com `npm run build`.
- [x] Subir as atualizações para o GitHub e Vercel.
